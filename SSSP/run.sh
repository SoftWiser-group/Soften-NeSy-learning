...
# CUDA_VISIBLE_DEVICES=0 python3 bs_training.py --seed 0 --exp_name bs --net 'checkpoint/mlp_0_sl_log_0.t7'
# CUDA_VISIBLE_DEVICES=0 python3 bs_training.py --seed 0 --exp_name bs --net 'checkpoint/mlp_0_fs_linear_0.t7'
# CUDA_VISIBLE_DEVICES=0 python3 bs_training.py --seed 0 --exp_name bs --net 'checkpoint/vae_net_0_sup_0.t7'